...
const additionalLibrary: LibraryItem[] = [
  ...
  { id: "xian-incident", name: "西安事变纪念馆", keywords: ["西安事变纪念馆", "西安事变", "纪念馆", "红色景区", "红色文化"], duration: "约1.5小时", description: "西安事变纪念馆是在张学良将军公馆、杨虎城将军止园别墅等西安事变重要旧址基础上建立的专题性纪念馆。展览以1936年西安事变为主线，通过历史照片、文献档案、馆藏文物、场景复原和专题陈列，系统呈现西安事变发生的历史背景、主要过程、和平解决及其深远影响。游客可结合张学良公馆等历史建筑，了解张学良、杨虎城两位将军发动兵谏、推动停止内战与共同抗日的重要历史抉择，认识西安事变在促成第二次国共合作和抗日民族统一战线形成过程中的重要意义。", kind: "景点" },
  { id: "eighth-route-army-office", name: "八路军西安办事处纪念馆", keywords: ["八路军办事处", "西安八办", "七贤庄", "红色景区", "红色文化"], duration: "约1.5小时", description: "八路军西安办事处纪念馆位于西安市北新街七贤庄，是依托八路军驻西安办事处旧址建立的革命纪念馆。抗日战争时期，这里是中国共产党和八路军设在国民党统治区的重要公开办事机构，也是连接延安与全国各地的重要红色交通枢纽，承担宣传抗日主张、开展统一战线工作、采购转运物资以及接待和输送爱国青年奔赴延安等重要任务。纪念馆保留了七贤庄民国时期四合院建筑格局，通过办公室、接待室、机要室及相关人员住室的复原陈列，结合历史照片、文献和革命文物，系统展示八路军西安办事处在抗日民族统一战线中的历史作用。", kind: "景点" },
